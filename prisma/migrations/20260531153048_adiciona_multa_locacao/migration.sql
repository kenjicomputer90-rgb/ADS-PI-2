-- DropIndex
DROP INDEX "peca_produto_codigo_unico_key";
...
INSERT INTO "new_locacao" ("data_devolucao", "data_entrega", "data_evento", "id_cliente", "id_funcionario", "id_locacao", "id_usuario", "status") SELECT "data_devolucao", "data_entrega", "data_evento", "id_cliente", "id_funcionario", "id_locacao", "id_usuario", "status" FROM "locacao";
DROP TABLE "locacao";
